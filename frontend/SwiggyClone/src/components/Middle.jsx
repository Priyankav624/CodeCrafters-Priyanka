...
const Middle = () => {
  return (
    <div>
        ...
        <h1 style={{color:"#000000 ", fontWeight: "bold", marginTop:"50px" ,marginRight:"800px", marginLeft:"80px", fontSize:"55px"}}> Restaurants in your pocket</h1>
        <p style={{marginLeft:"80px", fontSize:"20px", color:"#6a6c6d" , marginRight:"800px", marginBottom:"40px"}}>Order from your favorite restaurants & track on the go, with the all-new Swiggy app.</p>
    </div>
  )
}
